  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="glass sticky top-0 z-30 border-b border-gray-200 px-6 h-14 flex items-center gap-4">
        ...
        <h1 className="font-semibold text-gray-800">My Patients</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        {isLoading ? (
          ...
          <div className="card p-12 text-center">
            ...
            <p className="text-gray-500 text-sm">No patients yet. Complete appointments to build your patient list.</p>
          </div>
        ) : (
                  ...
                  <div className="space-y-1.5 text-sm">
                    ...
                    {patient?.bloodGroup && (
                      <div className="text-gray-500 text-xs">
                        Blood group: <span className="text-gray-700">{patient.bloodGroup}</span>
                      </div>
                    )}
                  </div>
                </div>
