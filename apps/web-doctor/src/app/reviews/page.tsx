...
import { ChevronLeft, Star, MessageSquare, Loader2, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="flex gap-0.5">
      {Array.from({ length: 5 }, (_, i) => (
        <Star key={i} className={`w-4 h-4 ${i < rating ? 'text-amber-400 fill-current' : 'text-gray-400'}`} />
      ))}
    </div>
  );
}
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="glass sticky top-0 z-30 border-b border-gray-200 px-6 h-14 flex items-center gap-4">
        ...
        <h1 className="font-semibold text-gray-900">Patient Reviews</h1>
      </header>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="card p-6 mb-6 flex items-center gap-6">
          <div className="text-center">
            ...
            <div className="text-gray-500 text-xs mt-1">{reviews.length} reviews</div>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="card p-12 text-center">
            ...
            <p className="text-gray-600 text-sm">No reviews yet. Complete appointments to receive patient feedback.</p>
          </div>
        ) : (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {confirmDelete === rev.id ? (
                        <div className="flex items-center gap-1">
                          ...
                          >
                            {deleting === rev.id ? <Loader2 className="w-3 h-3 animate-spin" /> : 'Yes'}
                          </button>
