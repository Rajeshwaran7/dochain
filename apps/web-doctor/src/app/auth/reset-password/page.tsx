          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                minLength={8}
                className="w-full pl-10 pr-10 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder:text-gray-500 focus:outline-none focus:border-violet-500"
              />
