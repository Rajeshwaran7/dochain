        ...
        <div className="card p-8">
          <div className="mb-6 flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-violet-50">
              <Mail className="h-6 w-6 text-violet-600" aria-hidden />
            </div>
            <div>
              <h1 className="text-lg font-bold text-gray-900">Verify your email</h1>
              <p className="text-xs text-gray-600">One more step to access your dashboard</p>
            </div>
          </div>
...
/**
 * Shown after doctor registration when the user must verify email before signing in.
 */
export default function DoctorCheckEmailPage() {
  return (
    <Suspense
      fallback={
